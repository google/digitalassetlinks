...
# 'source' field of Check() requests.  Note that parsing errors should cause the
# API to abort the request immediately.

test_group: {
  name: 'comptest1201: source queries in Check requests'

  web_content: {
    url: 'https://secure-comptest1201.digitalassetlinks.org/.well-known/assetlinks.json'
    body: '[]'
  }

  web_content: {
    url: 'http://insecure-comptest1201.digitalassetlinks.org/.well-known/assetlinks.json'
    body: '[]'
  }

  android_content: {
    package_name: 'org.digtitalassetlinks.comptest1201'
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'https://secure-comptest1201.digitalassetlinks.org' } }
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'http://insecure-comptest1201.digitalassetlinks.org' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: SUCCESS
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'http://insecure-comptest1201.digitalassetlinks.org:80' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: SUCCESS
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'https://secure-comptest1201.digitalassetlinks.org:443' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: SUCCESS
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'https://secure-comptest1201.digitalassetlinks.org:99999' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: QUERY_PARSING_ERROR
  ...
  check_statements_tests: {
    ...
    request: {
      source: { web: { site: 'https://secure-comptest1201.digitalassetlinks.org/foo' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: QUERY_PARSING_ERROR
  ...
  check_statements_tests: {
    ...
    request: {
      source: { android_app: {
        package_name: 'org.digitalassetlinks.comptest1201'
      } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
...
test_group: {
  name: 'comptest1202: source queries in Check requests (non-standard ports)'
  stub_environment_only: true  # Non-standard HTTP port used.

  web_content: {
    url: 'http://insecure-comptest1202.digitalassetlinks.org:88/.well-known/assetlinks.json'
    body: '[]'
  }

  web_content: {
    url: 'https://secure-comptest1202.digitalassetlinks.org:444/.well-known/assetlinks.json'
    body: '[]'
  }
  ...
  check_statements_tests: {
    name: 'Typical list request with a web asset query (1)'
    request: {
      source: { web: { site: 'http://insecure-comptest1202.digitalassetlinks.org:88' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: SUCCESS
  ...
  check_statements_tests: {
    name: 'Typical list request with a web asset query (2)'
    request: {
      source: { web: { site: 'https://secure-comptest1202.digitalassetlinks.org:444' } }
      relation: 'delegate_permission/common.handle_all_urls'
      target: { web: { site: 'https://target.digitalassetlinks.org' } }
    }
    outcome: SUCCESS
